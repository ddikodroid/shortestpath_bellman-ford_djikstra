...
void Djikstra(struct Graph* graph, int src){
    int V = graph->V;
    int E = graph->E;
    int dist[V];
...
int main()
{
    ...
    struct Graph* baru = createGraph(V, E);
    ...
    cout << "time: " << (stop_s1-start_s1)/double(CLOCKS_PER_SEC)*1000<<" ms" << endl;

    int source = 1;
    cout<< "Space Complexity:"<<endl;
    cout<< "Djikstra: "<< V*V << endl;
    cout<< "Bellman-Ford: " << V*V << endl;
    cout<< "Time Complexity: "<<endl;
    cout<< "Djikstra: "<< source*E*log2(E)+V << endl;
    cout<< "Bellman-Ford: " << source*E*V << endl;
    return 0;
}
